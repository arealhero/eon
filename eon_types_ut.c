...
test_while_statements(Test_Context* test_context)
{
...

    {
        ...
        ASSERT_EQUAL(body->statements_count, 1);
        ASSERT_EQUAL(body->every_path_returns, true); // FIXME(vlad): Not every path returns here.
...
#define DECLARE_BINARY_OPERATION_TEST_INFO(Type, operation)         \
    ...
    const Number_Test_Info assignment_test_infos[] = {
        FOR_EACH_INTEGER_TYPE_WITH_ARGS(DECLARE_BINARY_OPERATION_TEST_INFO, "+")
        FOR_EACH_FLOAT_TYPE_WITH_ARGS(DECLARE_BINARY_OPERATION_TEST_INFO, "+")
...
#define DECLARE_RETURN_TEST_INFO(Type, operation)                    \
    ...
    const Number_Test_Info return_test_infos[] = {
        FOR_EACH_INTEGER_TYPE_WITH_ARGS(DECLARE_RETURN_TEST_INFO, "+")
        FOR_EACH_FLOAT_TYPE_WITH_ARGS(DECLARE_RETURN_TEST_INFO, "+")
