...
#define FOR_EACH_SIGNED_INTEGER_TYPE_WITH_ARGS(DO, ...) \
    DO(s8, __VA_ARGS__)                                 \
    DO(s16, __VA_ARGS__)                                \
    DO(s32, __VA_ARGS__)                                \
    DO(s64, __VA_ARGS__)                                \

#define FOR_EACH_UNSIGNED_INTEGER_TYPE_WITH_ARGS(DO, ...) \
    DO(u8, __VA_ARGS__)                                   \
    DO(u16, __VA_ARGS__)                                  \
    DO(u32, __VA_ARGS__)                                  \
    DO(u64, __VA_ARGS__)                                  \

#define FOR_EACH_INTEGER_TYPE_WITH_ARGS(DO, ...)                        \
    FOR_EACH_SIGNED_INTEGER_TYPE_WITH_ARGS(DO, __VA_ARGS__)             \
    FOR_EACH_UNSIGNED_INTEGER_TYPE_WITH_ARGS(DO, __VA_ARGS__)

#define FOR_EACH_FLOAT_TYPE_WITH_ARGS(DO, ...)  \
    DO(f32, __VA_ARGS__)                        \
    DO(f64, __VA_ARGS__)

#define FOR_EACH_SIGNED_INTEGER_TYPE(DO) FOR_EACH_SIGNED_INTEGER_TYPE_WITH_ARGS(DO, 0)
#define FOR_EACH_UNSIGNED_INTEGER_TYPE(DO) FOR_EACH_UNSIGNED_INTEGER_TYPE_WITH_ARGS(DO, 0)
#define FOR_EACH_INTEGER_TYPE(DO) FOR_EACH_INTEGER_TYPE_WITH_ARGS(DO, 0)
#define FOR_EACH_FLOAT_TYPE(DO) FOR_EACH_FLOAT_TYPE_WITH_ARGS(DO, 0)
